...
htmlhelp_basename = 'GOVUKOperationsManualdoc'
...
latex_documents = [
  ('index', 'GOVUKOperationsManual.tex', u'GOVUK Operations Manual',
...
edit_on_github_project = 'gds/opsmanual'
edit_on_github_branch = 'master'
edit_on_github_root_url = 'https://github.gds'
